...
const FooterCard = () => {
  ...
  return (
    <div className="text-gray-900 bg-gray-200 rounded-3xl p-12 text-center">
      ...
      <button
        ref={btnRef}
        className="bg-gradient-to-l from-indigo-600 to-indigo-800 px-8 md:px-12 py-3 text-white rounded-full text-xl md:text-2xl font-medium relative overflow-hidden w-full md:w-1/2 h-[100px] hover:scale-105 transition-all duration-500"
      >
        <span
          ref={text1Ref}
